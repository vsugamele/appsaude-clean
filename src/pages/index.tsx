...
import { Bars3Icon as MenuIcon, UserIcon, CameraIcon, BeakerIcon } from '@heroicons/react/24/outline'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button className="bg-green-500 text-white p-4 rounded-lg flex items-center justify-center gap-2">
            <CameraIcon className="h-5 w-5" />
            Registrar Refeição
          </button>
          <button className="bg-blue-500 text-white p-4 rounded-lg flex items-center justify-center gap-2">
